...
All work must be done within the git worktree `/Users/marcoskim/Trabajos_Programacion/ubf_conferencia/.worktrees/task-002-1785508445`.
```bash
cd /Users/marcoskim/Trabajos_Programacion/ubf_conferencia/.worktrees/task-002-1785508445
```
Do not make changes directly on the main branch.

Branch name: `task-002-1785508445/task`
...
```
/Users/marcoskim/Trabajos_Programacion/ubf_conferencia/.team/tasks/002-f8-015/runs/task-002-1785508445
```

Write the result summary to `/Users/marcoskim/Trabajos_Programacion/ubf_conferencia/.team/tasks/002-f8-015/runs/task-002-1785508445/summary.md`.
