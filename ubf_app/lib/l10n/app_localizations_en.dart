...
class AppLocalizationsEn extends AppLocalizations {
  ...
  @override
  String get epTourAddItem => 'Add an item';

  @override
  String get epTourItemName => 'What it is';

  @override
  String get epTourItemHint => 'e.g. Park entrance fee';

  @override
  String get epTourItemRemove => 'Remove this item';
  ...
  @override
  String get optionsWhoSignedUp => 'Who has signed up';

  @override
  String get optionsNobodyYet => 'Nobody yet — you would be first';

  @override
  String get optionsSignupsFailed => 'Could not load the list';

  @override
  String get epTourMinSignups => 'Runs from';
  ...
  String optionsNeedsMore(int min, int now) {
    return 'Needs $min people to run — $now so far';
  }
  ...
  String hotelMustPick(int nights) {
    return 'You are staying $nights night(s) outside the retreat, so a room must be chosen.';
  }
  ...
  @override
  String get costBarExtraKindMeals => 'meals';

  @override
  String get costBarExtraKindLodging => 'lodging';

  @override
  String get costBarExtraKindAirfare => 'airfare';

  @override
  String get costBarExtraKindOther => 'other';

  @override
  String costBarExtraNote(String kinds) {
    return 'Not covered by the tour price: $kinds. You pay these yourself.';
  }

  @override
  String get summaryExtrasTitle => 'Not covered by the tour price';
  ...
  @override
  String get companionRegistersYes => 'Yes, separately';

  @override
  String get companionRegistersNo => 'No — cannot register';
  ...
  @override
  String get companionBedQ => 'Does this person need a bed?';

  @override
  String get companionBedYes => 'Yes';

  @override
  String get companionBedNo => 'No — shares with me';
  ...
  String companionNoFee(int age) {
    return 'No conference fee for children aged $age and under.';
  }
  ...
  @override
  String get expCompanionsCol => 'Companions';

  @override
  String mealsPlusCompanions(int count) {
    return 'plus $count children travelling with them';
  }

  @override
  String annTranslated(String langs) {
    return 'auto-translated · $langs';
  }
